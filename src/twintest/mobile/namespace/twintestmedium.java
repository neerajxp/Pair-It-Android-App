...
public class twintestmedium extends Activity {
	GameMainClass gm ;
	Dialog dialog ;
	Button btname;
	Button btnclicks;
	...
	public void onCreate(Bundle savedInstanceState) {
	   ...
	   setContentView(R.layout.twintestmedium);
	   ...
	   if(!gm.CreateGame(this, twintestmedium.this)==true)
	   {
	   	finish();
	   }
	   gm.noofclicks=0;
	   ...
	   catch(Exception ex)
	   {
	    ...
	    if(TwinTestActivity.TIMERON.equalsIgnoreCase("ON"))
		{
	    	...
	    	timer=new MyCounter(gm.timermedium,1000);
	    	timer.start();
	    	gm.timerticks=0;
...
//		    	show names on top	  		
		    	...
		    	if(gm.UserClicks.size()==1)
		    	{
		    		...
		    		gm.CheckAnswer(this, twintestmedium.this);

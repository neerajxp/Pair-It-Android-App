...
public class twintest6 extends Activity {
	public GameMainClass gm ;
Dialog dialog ;
Button btname;
Button btnclicks;
...
public void onCreate(Bundle savedInstanceState) {
   ...
   setContentView(R.layout.twintest);
   ...
   if(!gm.CreateGame(this, twintest6.this)==true)
   {
   	finish();
   }
   gm.noofclicks=0;
   ...
   try
   {
    ...
    // gm.volumelevel=am.getStreamVolume(AudioManager.STREAM_VOICE_CALL);
   ...
   catch(Exception ex)
   {
    ...
    if(TwinTestActivity.TIMERON.equalsIgnoreCase("ON"))
	{
    	...
    	timer=new MyCounter(gm.timereasy,1000);
    	timer.start();
    	gm.timerticks=0;
   ...
   int btnid= view.getId();	    	    
   	...
   	{	    				    		
	    	...
	    	if(TwinTestActivity.PAIRTYPE.equalsIgnoreCase("Numbers"))
	    	{
	    		...
	    		b1.setTextColor(Color.parseColor("#3F48CC"));
	    	}
	    	...
	    	if(gm.UserClicks.size()==1)
	    	{
	    		...
	    		gm.CheckAnswer(this, twintest6.this);
